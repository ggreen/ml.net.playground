See https://www.kaggle.com/datasets/navins7/vehicle-maintenance-record/


```shell
cd car-maintenance
mlnet classification --dataset "Vehicle-Maintenance-Service-Records.csv" --label-col 1 --has-header false --name SentimentModel  --train-time 60
```
